...
_LAZY: dict[str, str] = {
    ...
    "validate_custom_image": "terok.lib.api.project",
    "validate_gpus": "terok.lib.api.project",
    "detect_gpu_choices": "terok.lib.api.project",
    "GpuDeviceChoice": "terok.lib.api.project",
    "BASE_GPU_VENDOR": "terok.lib.api.project",
    "CUSTOM_BASE": "terok.lib.api.project",
    "EGRESS_SETS": "terok.lib.api.project",
    "OS_PACKAGES_SUMMARY": "terok.lib.api.project",
    "CUSTOM_IMAGE_WARNING": "terok.lib.api.project",
    ...
    "DEGRADED_DNS_TIERS": "terok.lib.api.task",
    "DeleteProjectResult": "terok.lib.api.project",
    "DnsTierWarning": "terok.lib.api.task",
    ...
    "describe_egress_sets": "terok.lib.api.project",
    "discover_projects": "terok.lib.api.project",
    "dns_tier_warning": "terok.lib.api.task",
    ...
    "load_auth_providers": "terok.lib.api.agents",
    ...
    "selected_egress_sets": "terok.lib.api.project",
    ...
    "set_project_shield_sets": "terok.lib.api.project",
