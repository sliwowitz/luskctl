...
class PollingMixin:
    ...
    async def _load_container_state_worker(
        ...
        from ..lib.containers import get_task_container_state
    ...
    async def _poll_upstream_worker(self, project_id: str) -> None:
        ...
        from ..lib.git_gate import compare_gate_vs_upstream
    ...
    async def _sync_worker(
        ...
        from ..lib.git_gate import compare_gate_vs_upstream, sync_gate_branches
