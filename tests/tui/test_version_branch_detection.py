...
class VersionModuleTests(unittest.TestCase):
    ...
    def test_get_version_info_returns_tuple(self) -> None:
        ...
        from luskctl.core.version import get_version_info
    ...
    def test_get_version_info_without_branch_data(self) -> None:
        ...
        with mock.patch("luskctl.core.version.subprocess.run") as mock_run:
            mock_run.side_effect = FileNotFoundError("git not found")

            from luskctl.core.version import get_version_info

            with mock.patch("luskctl.core.version._get_pep610_revision", return_value=None):
...
class Pep610Tests(unittest.TestCase):
    ...
    def test_pep610_requested_revision(self) -> None:
        ...
        from luskctl.core.version import _get_pep610_revision

        direct_url = json.dumps({"vcs_info": {"requested_revision": "feature/foo"}})
        dist = mock.MagicMock()
        dist.read_text.return_value = direct_url

        with mock.patch("luskctl.core.version.metadata.distribution", return_value=dist):
...
class LiveGitDetectionTests(unittest.TestCase):
    ...
    def test_git_detection_with_branch(self) -> None:
        ...
        with mock.patch("luskctl.core.version.subprocess.run", side_effect=mock_run):
            with mock.patch("luskctl.core.version._get_pep610_revision", return_value=None):
                # Mock pyproject.toml exists
                with mock.patch("luskctl.core.version.Path.exists", return_value=True):
                    _, branch = get_version_info()
    ...
    def test_git_detection_no_pyproject(self) -> None:
        ...
        with mock.patch("luskctl.core.version._get_pep610_revision", return_value=None):
            with mock.patch("luskctl.core.version.Path.exists", return_value=False):
    ...
    def test_pep610_takes_priority_over_git(self) -> None:
        ...
        with mock.patch("luskctl.core.version._get_pep610_revision", return_value="vcs-branch"):
            with mock.patch("luskctl.core.version.Path.exists", return_value=True):
                with mock.patch("luskctl.core.version.subprocess.run") as mock_run:
                    _, branch = get_version_info()
...
class CLIVersionTests(unittest.TestCase):
    ...
    def test_cli_version_matches_module_version(self) -> None:
        ...
        from luskctl.core.version import format_version_string, get_version_info
