...
def _is_tagged_release() -> bool:
    ...
    try:
        ...
        # Git command failed or timed out - not a tagged release
        pass
    return False
...
def _get_git_branch() -> str | None:
    ...
    try:
        ...
        # Git not available or command failed - not in a git repository
        pass
    return None
...
def _write_branch_info(branch_name: str) -> None:
    ...
    """
    # Use repr() to properly escape the branch name (handles quotes, backslashes, etc.)
